...
* 有効な操作がない場合のサイドバーの動作修正 [詳細](https://github.com/technote-space/marker-animation/issues/181)
* [すべての差分](https://github.com/technote-space/marker-animation/pull/209)
...
= 2.1.3 (2019/7/17) =
* Chore: Add COC & CONTRIBUTING
* Chore: Tweaks

= 2.1.2 (2019/7/16) =
* Feature: Add GitHub Pages
* Feature: Update packages
* Chore: Update tests
...
* Changed: develop version download url
